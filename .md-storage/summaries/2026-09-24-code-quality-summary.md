...
|----------|---------|----------|
| **ANDROID_BEST_PRACTICES.md** | Binding development guidelines | Root |
| **ANTIPATTERNS_REPORT.md** | Audit findings with 30+ issues | Root |
| **detekt.yml** | Detekt static analysis configuration | Root |
| **lint/** | Custom lint rules module | `lint/` |
| **gradle/lint.gradle.kts** | Lint Gradle configuration | `gradle/` |
| **.git/hooks/pre-commit.sh** | Pre-commit validation hook | `.git/hooks/` |
| **WORK_PLAN.md** | Updated with enforcement status | Root |
...
- [ANTIPATTERNS_REPORT.md](./ANTIPATTERNS_REPORT.md) - Detailed audit findings
